...
Fill in the code below to make a faceted plot that plots the counts across different combinations
...
how many rows or columns you want in your faceted plot.
...
However, we might be interested in how different different taxon's counts change together.
...
appropriate plotting layer to make a scatter plot.
