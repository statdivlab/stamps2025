...
1. Read the "phylum_data" file in the "data" folder and create a new data frame in which you make a new column for the sum of counts of *Acidobacteria* and *Fusobacteria*, maintain only the "Location", "Month", "Season", "Type" and the new column you created, and retain only samples that have positive counts in the new column. 
