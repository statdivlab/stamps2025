...
First, we will summarise the total counts for each taxon across all of our samples using 
...
Now, say we want to make a scatter plot of our taxon counts. This is about the simplest
...
a summary of the counts. We could try using a bar plot instead.
