...
Now, let's fit a model with multiple covariates. Let's consider `Treatment Group` and `Sample Type`. In order to fit this model, add the right hand side of the formula below, using the `+` operator to add a second covariate. 
