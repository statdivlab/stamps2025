...
fastEmu_test <- fastEmuFit(formula = ~ Group,
                           ...
                           reference_set = which(colnames(bigger_Y) %in% colnames(small_Y)),
...
```{r, message = FALSE}
dds <- DESeqDataSetFromMatrix(countData = small_Y_transpose,
...
```{r, message = FALSE}
linda_res <- linda(feature.dat = small_Y_transpose, meta.dat = wirbel_sample[ch_study_obs, ],
